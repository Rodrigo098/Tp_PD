...
public class ConsultaFiltros extends Geral{
    private String nome, local;
    private LocalDate limData1, limData2;
    private int horaInicio, horaFim;

    public ConsultaFiltros(Message_types tipo, String nome, String local, LocalDate limData1, LocalDate limData2, int horaInicio, int horaFim) {
        super(tipo);
    }
